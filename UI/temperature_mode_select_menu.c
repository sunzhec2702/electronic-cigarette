...
void temperature_mode_select_draw_current_value(void* pt)
{
    ...
    switch(current_index_value) {
        case NI_MODE:
            OLED_ShowString_Mode(16, page1, "COIL", 16, 1);
            OLED_ShowString_Mode(24, page2, "NI", 16, 1);
            break;
        case TI_MODE:
            OLED_ShowString_Mode(16, page1, "COIL", 16, 1);
            OLED_ShowString_Mode(24, page2, "TI", 16, 1);
            break;
        case SS_MODE:
            OLED_ShowString_Mode(16, page1, "COIL", 16, 1);
            OLED_ShowString_Mode(24, page2, "SS", 16, 1);
            break;
        case M1_MODE:
            OLED_ShowString_Mode(16, page1, "COIL", 16, 1);
            OLED_ShowString_Mode(24, page2, "M1", 16, 1);
            break;
        case M2_MODE:
            OLED_ShowString_Mode(16, page1, "COIL", 16, 1);
            OLED_ShowString_Mode(24, page2, "M2", 16, 1);
            break;
        case M3_MODE:
            OLED_ShowString_Mode(16, page1, "COIL", 16, 1);
            OLED_ShowString_Mode(24, page2, "M3", 16, 1);
            break;
        default:
            current_index_value = 0;
            temperatue_mode_backup();
