...
void smoke_mode_select_draw_current_value(void* pt)
{
    ...
    */
    ...
    if (get_value_key_lock() != SYS_LOCK) {
        draw_menu_select_array(24, 2, 0);
        draw_menu_select_array(24, 12, 1);
    }

//    OLED_SHOW_SPACE(0, page1, 16, 64);
//    OLED_SHOW_SPACE(0, page2, 16, 64);
    switch(current_index_value) {
        case MENU_SMOKE_POWER_MODE:
            OLED_ShowString_Mode(12, page1, "POWER", 16, 1);
            OLED_ShowString_Mode(16, page2, "MODE", 16, 1);
            break;
        case MENU_SMOKE_TEMPERATURE_MODE:
            OLED_ShowString_Mode(16, page1, "TEMP", 16, 1);
            OLED_ShowString_Mode(16, page2, "MODE", 16, 1);
            break;
        case MENU_SMOKE_KEY_LOCK:
            if (get_value_key_lock() == SYS_UNLOCK) {
                OLED_ShowString_Mode(16, page1, "LOCK", 16, 1);
                OLED_ShowString_Mode(12, page2, "ATTRI", 16, 1);
            } else {
                OLED_ShowString_Mode(8, page1, "UNLOCK", 16, 1);
                OLED_ShowString_Mode(12, page2, "ATTRI", 16, 1);
            }
            break;
        case MENU_SMOKE_ABOUT:
            OLED_ShowString_Mode(12, page1, "ABOUT", 16, 1);
            break;
    }
#endif
}
