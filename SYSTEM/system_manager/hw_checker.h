...
#define MAX_POWER_VALUE (MAX_POWER_VALUE_W*10)
#define MIN_POWER_VALUE 70
#define MAX_VOLTAGE_VALUE   750
#define MIN_CURRENT_VALUE   0
#define MAX_CURRENT_VALUE   3000
#define MAX_BYPASS_CURRENT_VALUE_BYPASS    3000
...
extern u8 check_static_battery(void);
extern u8 check_dynamic_battery(void);
